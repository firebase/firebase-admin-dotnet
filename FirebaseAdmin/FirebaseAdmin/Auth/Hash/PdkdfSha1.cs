...
namespace FirebaseAdmin.Auth.Hash
{
  ...
  /// </summary>
  public sealed class PdkdfSha1 : RepeatableHash
  {
    /// <summary>
    ...
    /// <summary>
    /// Gets the minimum number of rounds for an Pdkdf2 Sha1 hash which is 0.
    /// </summary>
    protected override int MinRounds { get { return 0; } }

    /// <summary>
    /// Gets the maximum number of rounds for an Pdkdf2 Sha1 hash which is 120000.
    /// </summary>

...
namespace FirebaseAdmin.Tests.Messaging
{
    ...
    {
        [Fact]
        public void EmptyMulticastMessage()
        {
            var message = new MulticastMessage
            {
                Tokens = new[] { "test-token" },
            };
        ...
        {
            var original = new MulticastMessage
            {
            ...
            var copy = NewtonsoftJsonSerializer.Instance.Deserialize<MulticastMessage>(json);
            Assert.True(original.Tokens.SequenceEqual(copy.Tokens));
        ...
        public void Copy()
        {
            ...
            Assert.NotSame(original.Tokens, copy.Tokens);
        ...
        [Fact]
        public void MessageWithNullTokens()
        {
            Assert.Throws<ArgumentException>(() => new MulticastMessage().CopyAndValidate());
        }

        [Fact]
        public void MessageWithNoTokens()
        {
        ...
        private void AssertJsonEquals(JObject expected, MulticastMessage actual)
        {
